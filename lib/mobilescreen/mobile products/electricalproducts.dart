...
class MobileElectricalProducts extends StatefulWidget {
  const MobileElectricalProducts({super.key});

  @override
  State<MobileElectricalProducts> createState() => _MobileElectricalProductsState();
}

class _MobileElectricalProductsState extends State<MobileElectricalProducts> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            cusText("ELECTRICAL ITEMS", green, 20, FontWeight.bold),
            SizedBox(height: 10.h),
            SizedBox(
              height: 300.h,
              width: 350.w,
              child: Image.network(
                "https://i.ibb.co/MDGZJLvH/EELC.webp",
                fit: BoxFit.cover,
                errorBuilder:
            ...
            cusText("Top Rated electrical Product", green, 20, FontWeight.bold),
            SizedBox(height: 15.h),

            Obx(() {
              if (getxController.elecbool.value) {
                return Center(child: CircularProgressIndicator());
              }
              if (getxController.elecProducs.isEmpty) {
                return Center(
                  child: Text(
                    "No products found.",
              ...
              return SizedBox(
                ...
                child: Wrap(
                  ...
                  children:
                      getxController.elecProducs.map((product) {
                        return Padding(
