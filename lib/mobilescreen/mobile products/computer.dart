...
class MobileComputerProducts extends StatefulWidget {
  const MobileComputerProducts({super.key});

  @override
  State<MobileComputerProducts> createState() => _MobileComputerProductsState();
}

class _MobileComputerProductsState extends State<MobileComputerProducts> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            cusText("COMPUTER ITEMS", green, 20, FontWeight.bold),
            ...
            Obx(() {
              ...
              if (getxController.computerProdut.isEmpty) {
                return Center(
                  child: Text(
                    "No products found.",
