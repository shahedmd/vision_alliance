...
class MobilePSproducts extends StatefulWidget {
  const MobilePSproducts({super.key});

  @override
  State<MobilePSproducts> createState() => _MobilePSproductsState();
}

class _MobilePSproductsState extends State<MobilePSproducts> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            cusText("POWERPLANT & SUBSTATION PRODUCT", green, 20, FontWeight.bold),
            ...
            cusText("Top Rated Powerplant & Substation Product", green, 18, FontWeight.bold),
            SizedBox(height: 15.h),
