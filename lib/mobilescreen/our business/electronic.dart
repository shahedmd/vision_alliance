...
class MobileElectrical extends StatefulWidget {
  const MobileElectrical({super.key});

  @override
  State<MobileElectrical> createState() => _MobileElectricalState();
}

class _MobileElectricalState extends State<MobileElectrical> {
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              cusText("OUR ELECTRICAL BUSINESS", green, 20, FontWeight.bold),
              ...
              Obx(() {
                ...
                return SizedBox(
                  ...
                  child: Wrap(
                    ...
                    children:
                        getxController.electricalProductslistlimit.map((
                          product,
                        ) {
                          return Padding(
