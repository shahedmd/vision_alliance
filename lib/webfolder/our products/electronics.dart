...
class ElectronicsProductPage extends StatefulWidget {
  const ElectronicsProductPage({super.key});

  @override
  State<ElectronicsProductPage> createState() => ElectronicsProductPageState();
}

class ElectronicsProductPageState extends State<ElectronicsProductPage> {
                ...
                children: [
                 ...
                 Positioned(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          cusText("ELECTRONICS ITEMS", green, 30, FontWeight.bold),
